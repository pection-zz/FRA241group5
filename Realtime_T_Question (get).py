...
class QUESTIONSTUDENT(object):
    ...
    def callQuestion(self,d="",sid=""):#input sample "2016-11-22","141"
        ...
        #for i in range(0,10):
         ...
         #gom=0: gom=1
                   ...
                   # x = 5
                    ...
                    #if y <= x:
                     # the = "2016-11-09"
        gata = self.callQuestion(the,"241001") #self.callQuestion('2016-11-08','241001')
        data = str(gata)
   ...
   # print callQuestion('2016-11-08','241001')
    def data(self,i):
        self.the  = long(self.the)+ i
        self.lineEdit.setText(_translate("MainWindow", str(self.the), None))
