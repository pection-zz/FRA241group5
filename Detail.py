...
class DETAIL(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setFixedSize(210, 400)
        self.centralwidget = QtGui.QWidget(MainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.verticalLayoutWidget = QtGui.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 50, 170, 300))
        ...
        self.back1.setGeometry(QtCore.QRect(100, 350, 80, 20))
        self.back1.setObjectName(_fromUtf8("BACK"))
        self.label = QtGui.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(60, 320, 71, 21))
        font = QtGui.QFont()
